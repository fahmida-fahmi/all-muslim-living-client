...
const FAQ = () => {
  return (
    <div className="w-full md:max-w-4xl mx-auto px-4 py-32">
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">What is All Muslim Living?</h2>
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">How do I join All Muslim Living?</h2>
          <p className="text-md md:text-lg text-gray-600 mt-2">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">Is there a mobile app for All Muslim Living?</h2>
          <p className="text-md md:text-lg text-gray-600 mt-2">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">How can I contact customer support?</h2>
          <p className="text-md md:text-lg text-gray-600 mt-2">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">Do you have an affiliate program?</h2>
          <p className="text-md md:text-lg text-gray-600 mt-2">
